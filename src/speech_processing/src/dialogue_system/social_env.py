...
class SocialEnv(gym.Env):
    ...
    Second, we have 4 steps: set_parameters, transporting_search, transporting_fetch, and transporting_deliver. You need to generate a sentence to announce your current steps.
    ...
    step: "set_parameters",
    interruptible: True,
    dict_object: {type: "null", color: "null", name: "null", location: "null", size: "null"}
    move_arm: False,
    move_base: False,
    ...
    interruptible: True,
    dict_object: {type: "cup", color: "red", name: "null", location: "null", size: "null"},
    move_arm: False,
    move_base: False,
    current_location: "kitchen",
